...
# P2 = geo.addPoint(0,75.5e-4, 0, lc_top)
...
# n stop
P13 = geo.addPoint(0, 30.25e-4, 0, ln_up)
P14 = geo.addPoint(0, 45.25e-4, 0, ln_up)
P23 = geo.addPoint(-0.5e-4, 45.25e-4, 0, ln_up)
P24 = geo.addPoint(-0.5e-4, 30.25e-4, 0, ln_up)
P15 = geo.addPoint(-1e-4, 45.25e-4, 0, ln_up)
P16 = geo.addPoint(-1e-4, 30.25e-4, 0, ln_up)
...
# P13 = geo.addPoint(0, 30.25e-4, 0, lc_top)
# P14 = geo.addPoint(0, 45.25e-4, 0, lc_top)
...
L37 = geo.addLine(P17, P3)
L38 = geo.addLine(P3, P4)
L39 = geo.addLine(P4, P18)
# L41 = geo.addLine(P17, P18)

loop11 = geo.addCurveLoop([L37, L38, L39, -L41])
...
gmsh.model.addPhysicalGroup(2, [surf1, surf2, surf3, surf4, surf5, surf6, surf7, surf8, surf9, surf10, surf11], name="CMOS_strip_B")

gmsh.option.setNumber("Geometry.MatchMeshTolerance", 1e-12)
gmsh.model.mesh.generate(2)

gmsh.option.setNumber("Mesh.MshFileVersion", 2.2)
gmsh.write(os.getenv("RASER_SETTING_PATH")+"/detector/CMOS_strip_B.msh")
gmsh.finalize()
# gmsh.fltk.run()
